...
#include "DifferentialCarPawn.generated.h"
...
UCLASS(config=Game)
class AIRSIM_API ADifferentialCarPawn : public ADifferentialWheeledVehicle
{
	GENERATED_BODY()

public:
	ADifferentialCarPawn();
    ...
    UDS_VehicleMovementComponent* getVehicleMovementComponent() const;
    const msr::airlib::CarApiBase::DifferentialCarControls& getKeyBoardControls() const
    {
...
private:
    ...
    void onRight(float Val);
    void onLeft(float Val);
...
private:
    ...
    msr::airlib::CarApiBase::DifferentialCarControls keyboard_controls_;
