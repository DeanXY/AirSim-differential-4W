...
namespace airlib
{
    ...
    //******************************
    class DifferentialCarRpcLibServer : public RpcLibServerBase
    {
    public:
        DifferentialCarRpcLibServer(ApiProvider* api_provider, string server_address, uint16_t port = RpcLibPort);
        virtual ~DifferentialCarRpcLibServer();
