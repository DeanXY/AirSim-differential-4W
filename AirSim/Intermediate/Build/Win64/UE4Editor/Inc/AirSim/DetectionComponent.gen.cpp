...
static struct FScriptStruct_AirSim_StaticRegisterNativesFDetectionInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("DetectionInfo")),new UScriptStruct::TCppStructOps<FDetectionInfo>);
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDetectionInfo_Hash() { return 3287568751U; }
	...
	IMPLEMENT_CLASS(UDetectionComponent, 3364079392);
