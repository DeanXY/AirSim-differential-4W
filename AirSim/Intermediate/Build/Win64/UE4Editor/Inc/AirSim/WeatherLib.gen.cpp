...
// End Cross Module References
	...
	struct Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics
	{
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_fog;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::NewProp_fog = { "fog", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(WeatherLib_eventsetWeatherFog_Parms, fog), Z_Construct_UClass_AExponentialHeightFog_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::NewProp_fog,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::Function_MetaDataParams[] = {
		{ "Category", "Weather" },
		{ "ModuleRelativePath", "Weather/WeatherLib.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWeatherLib, nullptr, "setWeatherFog", nullptr, nullptr, sizeof(WeatherLib_eventsetWeatherFog_Parms), Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UWeatherLib_setWeatherFog()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UWeatherLib_setWeatherFog_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UWeatherLib_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UWeatherLib_setWeatherFog, "setWeatherFog" }, // 689604547
	...
	IMPLEMENT_CLASS(UWeatherLib, 2647802720);
