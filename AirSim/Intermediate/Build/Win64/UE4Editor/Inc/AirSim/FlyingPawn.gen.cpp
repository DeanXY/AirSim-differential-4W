...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_rotating_movements_;
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_rotating_movements__Inner;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFlyingPawn_Statics::NewProp_rotating_movements_ = { "rotating_movements_", nullptr, (EPropertyFlags)0x0040008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFlyingPawn, rotating_movements_), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AFlyingPawn_Statics::NewProp_rotating_movements__MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFlyingPawn_Statics::NewProp_rotating_movements__MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFlyingPawn_Statics::NewProp_rotating_movements__Inner = { "rotating_movements_", nullptr, (EPropertyFlags)0x0000000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_URotatingMovementComponent_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFlyingPawn_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFlyingPawn_Statics::NewProp_rotating_movements__Inner,
	...
	IMPLEMENT_CLASS(AFlyingPawn, 2645950337);
